...
/// Palette mirrors the Tailwind colors used in the React source so the Flutter
/// UI looks identical. Centralised here so feature widgets never reach for
/// hard-coded hex.
class AppColors {
  AppColors._();

  // Brand (Tailwind emerald + teal)
